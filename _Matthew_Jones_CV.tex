...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item
          {Conveyed TeddyBear to CyDen's Chief Scientific Officer and University supervisors.}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingSmall
      ...
      \resumeItemListStart
        \item {Programmed core functionality with team of 3 others for custom Operating System written in C, including processes, threads, scheduler, file system and virtual memory.}
      \resumeItemListEnd
