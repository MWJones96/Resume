...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\textbf{Programmer Analyst II}}{September 2020 -- Present}
		\resumeItemListStart
			\item {Designed and implemented new features into Electronic Data Capture (EDC) system, featuring a \linebreak Django-based backend and React-based frontend, to assist in conducting clinical trials on human subjects.}
			...
			\item {Developed backend APIs and rich frontend components to create reports for ClinOps teams displaying \linebreak detailed and personalized information about the current study to aid in future decision-making.}
		\resumeItemListEnd
