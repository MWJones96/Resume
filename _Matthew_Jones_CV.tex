...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\textbf{Programmer Analyst II}}{September 2020 -- Present}
		\resumeItemListStart
			...
			\item {Developed backend APIs to fetch and process tailored datasets required by ClinOps teams for current and future clinical trials, using Django REST Framework and PostgreSQL.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \item {Designed, built and deployed AlexaHEAT dashboard, using Java, JavaScript and DynamoDB, providing \linebreak over 300 Amazon employees easy access to real-time tailored datasets for their own projects.}
