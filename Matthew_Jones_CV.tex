...
\resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\textbf{Full Stack Developer II}}{September 2020 -- Present}
		\resumeItemListStart
			\item {Integrated brand new core features into medical data capture system, used by over 1,000 clinical staff, \linebreak developing for both Django backend and React frontend.}
			\item {Developed REST APIs to set and reset user email preferences, and to automatically send out emails to \linebreak those with preferences set, on any asynchronous event.}
			\item {Redesigned GUI for patient referral system, used by over 100,000 clinical staff, in reponse to updated \linebreak requirements, using GraphQL to easily fetch from multiple databases.}
			\item {Fixed known bugs and ensured all deployed code was rigorously-tested, ensuring high maintainability, \linebreak reliability, scalability and compliance with modern design practices.}
		\resumeItemListEnd
